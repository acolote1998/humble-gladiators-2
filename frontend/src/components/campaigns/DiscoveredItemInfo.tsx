...
export const DiscoveredItemInfo = ({
  ...
  return (
    <>
      ...
      <div className="cursor-pointer col-span-6 lg:col-span-8 relative bg-[var(--highlight-color)] border-[var(--highlight-color-border)] border rounded-md h-5 lg:h-10 group">
        <div
